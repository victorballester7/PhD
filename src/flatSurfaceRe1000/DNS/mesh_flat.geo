...
BL = 1 * deltaStar; // height of the second layer of quad elements
x0 = 50 * deltaStar; // x distance from inflow to gap
lengthOutflow = 600 * deltaStar; // length after the gap
...
// Micro parameters
size_triag_v_top = 20; // size of the elements in the upper triangular region
...
p_quad_h = 0.5;  
p_triag_h_outflow = 0.6; // densitiy concentration of elements in the triangular region of the domain, horizontally.
p_triag_h_inflow = 0.7;
