...
p_in_v_right_upper = p_in_v_right_lower; // densitiy concentration of elements inside the gap, vertically, near the right wall.
p_in_v_left_lower = 0.8; // densitiy concentration of elements inside the gap, vertically, near the left wall.
p_in_v_left_upper = p_in_v_left_lower; // densitiy concentration of elements inside the gap, vertically, near the left wall.
...
p_out_v_inflow_dense_upper = p_out_v_inflow_dense_lower; // densitiy concentration of elements outside the gap, vertically, near the inflow and the gap
...
p_out_v_outflow_dense_upper = p_out_v_outflow_dense_lower; // densitiy concentration of elements outside the gap, vertically, near the outflow and the gap
