...
p_out_v_inflow_dense_upper = 0.9; // densitiy concentration of elements outside the gap, vertically, near the inflow and the gap
...
p_out_v_outflow_dense_upper = 0.97; // densitiy concentration of elements outside the gap, vertically, near the outflow and the gap
...
a_out_v_inflow_sparse = r / (x0 - r) * (1 - p_out_v_inflow_dense_lower) / (1 - p_out_v_inflow_dense_lower^(N_out_v_inflow_dense + 1));
a_out_v_outflow_sparse = r / (lengthOutflow - r) * (1 - p_out_v_outflow_dense_lower) / (1 - p_out_v_outflow_dense_lower^(N_out_v_outflow_dense + 1));
