...
// ---------------------------
dx_t_outflow = Min(lengthQuadsOutflow * (1 - p_out_v_outflow) / (1 - p_out_v_outflow ^ (N_out_v_outflow)), BL * p_out_h ^ (N_out_h - 1) * (1 - p_out_h) / (1 - p_out_h ^ (N_out_h)));
a_triag_v_outflow = dx_t_outflow / (lengthOutflow - lengthQuadsOutflow);
...
N_triag_v_outflow = Ceil( Log( a_triag_v_outflow / (1 - p_triag_v_outflow + a_triag_v_outflow * p_triag_v_outflow) ) / Log(p_triag_v_outflow) );
N_triag_h_inflow = Ceil( h / size_triag_h_inflow );
N_triag_h_outflow = Ceil( h / size_triag_h_outflow );

Printf("N_out_v_outflow = %f\n", N_out_v_outflow);
Printf("lengthQuadsOutflow = %f\n", lengthQuadsOutflow);
Printf("p_out_v_outflow = %f\n", p_out_v_outflow);

Printf("N_out_h = %f\n", N_out_h);
Printf("BL = %f\n", BL);
Printf("p_out_h = %f\n", p_out_h);

Printf("dx_t_outflow = %f\n", dx_t_outflow);
