...
def fitting(x, y, incNS, p, limit_u, limit_v):
    ...
    def v_fit_scipy(eta, *params):
        return u_fit_func(eta, p, limit_v, *params)  # Add return here
    ...
    ufit_coeffs, _ = curve_fit(u_fit_scipy, x, f_tofit_u, p0=pu)
    vfit_coeffs, _ = curve_fit(v_fit_scipy, x, f_tofit_v, p0=pu)
