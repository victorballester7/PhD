...
s = 0.5; // length of non-constant quads left and right inside the gap
...
// outer quads
Curve Loop(1) = {-10, 11, 1, 31};
Plane Surface(1) = {1};
Curve Loop(6) = {21, 6, -22, -30};
Plane Surface(6) = {6};

// inside gap
Curve Loop(2) = {2, 15,32, 3, 33, 16, 34, 4,35, 17, -18, -40,-39,-41,-38,-37,-36, -14};
Plane Surface(2) = {2};

// triangular region
Curve Loop(3) = {-29, -26, 25, 8, 9, 27, 28, -31, 20, 14, 36, 37, 38, 41, 39, 40, 18, 5, 30};
Plane Surface(3) = {3};
...
Physical Curve(4) = {1, 20, 2, 15, 32, 3, 33, 16, 34, 4, 35, 17, 5, 21}; // wall


Physical Surface(100) = {1, 2, 4, 5, 6};
