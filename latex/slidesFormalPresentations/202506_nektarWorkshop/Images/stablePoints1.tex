...
\begin{tikzpicture}
	...
	{\fcolorbox{Cyan}{White}{\includegraphics[width=5cm]{../../../../scripts/Images/d4_w15.png}}};
	...
	(1.3,1.74) -- ([xshift=0.01cm,yshift=-0.01cm]img2.north west);

	\draw[
		line width=0.5pt,       % thin line
		Cyan,
	]
	(1.28,1.73) -- ([xshift=0.01cm,yshift=0.01cm]img2.south west);
