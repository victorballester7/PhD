...
\begin{tikzpicture}
	...
	{\fcolorbox{YellowOrange}{White}{\includegraphics[width=5cm]{../../../Images/d2.25_w35.png}}};
	...
	(1.82,0.01) -- ([xshift=0.01cm,yshift=-0.01cm]img2.north west);

	\draw[
	  line width=0.5pt,       % thin line
	  YellowOrange,
	] 
	(1.82,0) -- ([xshift=0.01cm,yshift=0.01cm]img2.south west);
