...
\begin{tikzpicture}
	...
	{\includegraphics[width=5cm]{../../../Images/incNS2dStabilityCurve.pdf}};
	...
	{\fcolorbox{Cyan}{White}{\includegraphics[width=5cm]{../../../Images/d1_w60_streamlines.png}}};

	\node[anchor=north,inner sep=0, outer sep=0] (img3) at ([yshift=-0.05cm]img2.north){\fcolorbox{black}{white}{\includegraphics[width=1.5cm]{../../../Images/d1_w60_real.png}}};
